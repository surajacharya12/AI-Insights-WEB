...
// Tools section
const toolItems = [{ icon: Settings, label: "Settings", path: "/settings" }];

const socialLinks = [
  { icon: Github, url: "https://github.com/surajacharya12", label: "GitHub" },
  {
    icon: Instagram,
    url: "https://www.instagram.com/suraj_acharyaa10/",
    label: "Instagram",
  },
  {
    icon: Linkedin,
    url: "https://www.linkedin.com/in/surajacharyaa/",
    label: "LinkedIn",
  },
  {
    icon: Facebook,
    url: "https://www.facebook.com/auraj.acharya/",
    label: "Facebook",
  },
  {
    icon: Twitter,
    url: "https://x.com/SURAJAC22891334",
    label: "Twitter",
  },
  {
    icon: Globe,
    url: "https://surajacharya10.com.np/",
    label: "Website",
  },
];
            ...
            <div className="px-3 py-4 bg-gradient-to-br from-green-50/50 to-blue-50/50 rounded-xl border border-green-100/50 mx-2 shadow-sm">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[10px] text-green-600 font-semibold uppercase tracking-wide truncate">
