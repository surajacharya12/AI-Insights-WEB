  ...
  return (
    <div className="flex h-screen md:h-[90vh] bg-linear-to-br from-green-50 to-green-100">
      ...
      <motion.div
        ...
        className={`fixed md:static z-40 w-64 h-full bg-white shadow-2xl flex flex-col transition-all duration-300 ${
      ...
      <div className="flex-1 flex flex-col p-4 md:p-10 overflow-hidden relative">
        ...
        <button
          ...
          className="md:hidden absolute top-4 left-4 z-50 p-2 bg-white rounded-lg shadow-md hover:bg-gray-100"
        >
          {sidebarOpen ? (
            <X className="w-6 h-6" />
          ) : (
        ...
        <div className="flex-1 bg-white rounded-3xl shadow-2xl p-4 flex flex-col overflow-hidden relative">
          ...
          <div className="mt-3 flex items-center gap-2">
            <textarea
              ...
              rows={1}
              className="flex-1 resize-none px-4 py-3 rounded-2xl border border-gray-300
